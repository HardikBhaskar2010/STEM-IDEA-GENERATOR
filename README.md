...
<img src="https://via.placeholder.com/60/a855f7/ffffff?text=P" alt="Purple"/><br/>
<b>Purple Fusion</b><br/>
#a855f7
</td>
<td align="center" width="14.28%">
<img src="https://via.placeholder.com/60/ec4899/ffffff?text=P" alt="Pink"/><br/>
<b>Pink Blossom</b><br/>
#ec4899
</td>
<td align="center" width="14.28%">
<img src="https://via.placeholder.com/60/3b82f6/ffffff?text=B" alt="Blue"/><br/>
<b>Ocean Blue</b><br/>
#3b82f6
</td>
<td align="center" width="14.28%">
<img src="https://via.placeholder.com/60/10b981/ffffff?text=G" alt="Green"/><br/>
<b>Matrix Green</b><br/>
#10b981
</td>
<td align="center" width="14.28%">
<img src="https://via.placeholder.com/60/ef4444/ffffff?text=R" alt="Red"/><br/>
<b>Cyber Red</b><br/>
#ef4444
</td>
<td align="center" width="14.28%">
<img src="https://via.placeholder.com/60/f97316/ffffff?text=O" alt="Orange"/><br/>
<b>Sunset Orange</b><br/>
#f97316
</td>
<td align="center" width="14.28%">
<img src="https://via.placeholder.com/60/a3a3a3/000000?text=G" alt="Gray"/><br/>
...
- ✨ Aceternity UI & shadcn/ui components (Spotlight, Splite, and more)
...
The frontend application consists of 18 distinct pages, each serving a specific purpose in the user journey:

1. **Welcome (`/`)**: The landing page for unauthenticated users, introducing the app and its features.
2. **Login (`/login`)**: The authentication portal for returning users.
3. **SignUp (`/signup`)**: Registration page for new users to create their accounts.
4. **Dashboard (`/dashboard`)**: The main hub for authenticated users, displaying overviews, recent projects, and quick actions.
5. **Veronica AI (`/veronica-ai`)**: The core AI assistant interface for generating custom STEM projects and code.
6. **Project Detail (`/project/:id`)**: Detailed view of a user's specific saved project, including Bill of Materials and steps.
7. **Veronica Project (`/veronica-project/:id`)**: Detailed view of a project that was specifically generated by Veronica AI.
8. **Components (`/components`)**: A comprehensive hardware catalog consisting of 500+ items with 3D previews.
...
| **3D & Rendering** | ![Three.js](https://img.shields.io/badge/Three.js-0.160.1-000000?style=flat-square&logo=three.js) ![React Three Fiber](https://img.shields.io/badge/R3F-8.18.0-000000?style=flat-square) ![Spline](https://img.shields.io/badge/Spline-3D-FF518A?style=flat-square) |
| **Animations** | ![Framer Motion](https://img.shields.io/badge/Framer_Motion-12.0-0055FF?style=flat-square) ![tsParticles](https://img.shields.io/badge/tsParticles-3.0-0099ff?style=flat-square) |
| **UI Components** | ![Tailwind](https://img.shields.io/badge/Tailwind-3.4.15-38B2AC?style=flat-square&logo=tailwind-css) ![shadcn/ui](https://img.shields.io/badge/shadcn/ui-latest-000000?style=flat-square) ![Aceternity UI](https://img.shields.io/badge/Aceternity_UI-latest-000000?style=flat-square) |
...
| **State** | ![React Context](https://img.shields.io/badge/Context_API-latest-61DAFB?style=flat-square) ![Zustand](https://img.shields.io/badge/Zustand-5.0-372131?style=flat-square) |
...
| **AI/ML** | ![OpenRouter](https://img.shields.io/badge/OpenRouter-Trinity_Large-FF6B6B?style=flat-square) ![Anthropic](https://img.shields.io/badge/Anthropic-latest-D4C7B8?style=flat-square) |
| **Sandboxing** | ![E2B Code Interpreter](https://img.shields.io/badge/E2B-Code_Interpreter-FF5500?style=flat-square) |
| **Database & Cache**| ![Supabase](https://img.shields.io/badge/Supabase-PostgreSQL-3ECF8E?style=flat-square&logo=supabase) ![Redis](https://img.shields.io/badge/Redis-5.0-DC382D?style=flat-square&logo=redis) |
| **Observability** | ![OpenTelemetry](https://img.shields.io/badge/OpenTelemetry-latest-eeeeee?style=flat-square) |
...
<td align="center" width="25%">
<img src="https://openrouter.ai/favicon.ico" width="60"/><br/>
<b>OpenRouter</b><br/>
<sub>AI Intelligence</sub>
</td>
<td align="center" width="25%">
<img src="https://supabase.com/favicon/favicon-32x32.png" width="60"/><br/>
<b>Supabase</b><br/>
<sub>Backend Power</sub>
</td>
<td align="center" width="25%">
<img src="https://ui.shadcn.com/favicon.ico" width="60"/><br/>
<b>shadcn/ui</b><br/>
...
[![Email](https://img.shields.io/badge/Email-hardik.bhaskar2010@gmail.com-EA4335?style=for-the-badge&logo=gmail)](mailto:hardik.bhaskar2010@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-HardikBhaskar2010-181717?style=for-the-badge&logo=github)](https://github.com/HardikBhaskar2010)

### 🔗 Project Links

[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-Visit_Now-6366f1?style=for-the-badge)](https://perfection-v4.vercel.app)
[![GitHub Repo](https://img.shields.io/badge/📦_Repository-View_Code-181717?style=for-the-badge&logo=github)](https://github.com/HardikBhaskar2010/STEM-IDEA-GENERATOR)
[![Backend API](https://img.shields.io/badge/⚡_Backend_API-View_Docs-009688?style=for-the-badge)](https://perfection-v2.onrender.com/docs)
...
<img src="https://via.placeholder.com/800x100/0f172a/a855f7?text=Built+with+❤️+and+Three.js+by+Hardik+Bhaskar+(Luna+Kitsune)" alt="Footer"/>

### *Empowering the next generation of makers and innovators*

**🌟 If you found this project helpful, please consider giving it a star!**

[![Star on GitHub](https://img.shields.io/github/stars/HardikBhaskar2010/STEM-IDEA-GENERATOR?style=social)](https://github.com/HardikBhaskar2010/STEM-IDEA-GENERATOR)
