...
type GridScanProps = {
  ...
  /** When true, listens for mousemove on window instead of the container.
   *  Use this when the container has pointer-events:none (e.g. as a global background). */
...
export const GridScan: React.FC<GridScanProps> = ({
  ...
  useEffect(() => {
    ...
    // track the window instead and calculate coords relative to the container.
