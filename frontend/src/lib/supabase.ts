...
if (!process.env.NEXT_PUBLIC_SUPABASE_URL || !process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY) {
  console.warn('⚠️ Supabase URL or Anon Key is missing. Using placeholder values for build compatibility.');
}
 ...
 * Creates a new user record if guest_id doesn't exist
 */
